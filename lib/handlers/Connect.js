...
function createOrLoadClientSession (connection, packet, clientId)
{

  let clientSession = this.sessionStore.lookup(clientId)
  if (!clientSession) {
     clientSession = this.sessionStore.insert(new ClientSession({ sessionId: clientId, cleanSession: packet.clean }))
  }
